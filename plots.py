...
def plot_trajectories(
    ...
    """
    Function for the fourth plot of the plot_metrics.py file
    Input(s)
        - savepath (str): path to save the image
        - ground_truth (xarray.Dataset): reference from which observations are taken from with dimension (batch=1, time=n, lat=181, lon=360, levels=13)
    ...
    time_steps_titles = ["2019-03-29 00:00"] + time_steps_titles
